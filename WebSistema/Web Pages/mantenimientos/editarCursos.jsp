<%-- 
    ...
    Created on : 03-oct-2021, 10:47:39
    Author     : nikol
--%>
...
<html>
    ...
    <div class="card" style="width: 50rem;padding: 30px 0px 0px 30px;">
        ...
        <form name=mod_opcion method=POST action="/WebSistema/controladorPrincipal">
            ...
            <td><input type="date" dateformat="y M d" name=xfec1 value="<c:out value='${curso.fec_ini}'/>"
                size=30></td></tr>
            <tr><th>Fecha de Final:</th>
            <td><input type="date" dateformat="y M d" name=xfec2 value="<c:out value='${curso.fec_fin}'/>"
                size=30></td></tr>
            <tr><th>Duracion:</th>
